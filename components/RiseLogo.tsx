    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className={`${sizeClasses[size]} relative flex items-center justify-center`}>
        ...
        >
          ...
          <g opacity="0.7">
            {/* Long Rays */}
            <line x1="50" y1="30" x2="50" y2="20" stroke="url(#sunGradient)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="75" y1="50" x2="85" y2="45" stroke="url(#sunGradient)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="25" y1="50" x2="15" y2="45" stroke="url(#sunGradient)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="65" y1="35" x2="75" y2="25" stroke="url(#sunGradient)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="35" y1="35" x2="25" y2="25" stroke="url(#sunGradient)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="70" y1="60" x2="80" y2="70" stroke="url(#sunGradient)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="30" y1="60" x2="20" y2="70" stroke="url(#sunGradient)" strokeWidth="2.5" strokeLinecap="round" />
            ...
            <line x1="62" y1="52" x2="70" y2="50" stroke="url(#sunGradient)" strokeWidth="2" strokeLinecap="round" />
            <line x1="38" y1="52" x2="30" y2="50" stroke="url(#sunGradient)" strokeWidth="2" strokeLinecap="round" />
          </g>
          ...
          {/* Subtle Clouds */}
          <ellipse cx="20" cy="25" rx="8" ry="5" fill="url(#cloudGradient)" opacity="0.6" />
          <ellipse cx="25" cy="25" rx="6" ry="4" fill="url(#cloudGradient)" opacity="0.6" />
          <ellipse cx="75" cy="30" rx="7" ry="4" fill="url(#cloudGradient)" opacity="0.5" />
          <ellipse cx="80" cy="30" rx="5" ry="3" fill="url(#cloudGradient)" opacity="0.5" />
        </svg>
      </div>
